# Quill Delta to React native Converter #
Converts [Quill's](https://quilljs.com) [Delta](https://quilljs.com/docs/delta/) format to React native (insert ops only) with properly nested lists.
...
Installation
```
npm install quill-delta-to-react-native
```

Usage
```javascript
var QuillDeltaToHtmlConverter = require('quill-delta-to-react-native').QuillDeltaToHtmlConverter;
